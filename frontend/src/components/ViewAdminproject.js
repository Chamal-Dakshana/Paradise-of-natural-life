    ...
    <div>
      ...
      <AdminprojectContainer>
        <div className="info">
          <div className="container">
            <div className="row my-5">
              <div className="col-sm-2">
                <Link to="/all" type="submit" className="btn" style={{borderRadius: "8px"}}>
          ...
          <p>
            <i className="fas fa-tag">{duration}</i>
          </p>
          <br />
          <p>{ result}</p>
          <div class="grid gap-5 grid-cols-5">
            ...
            <Link
              ...
              className="btn"
              style={{ color: "#b6465f", background: "#9bb1ff", borderRadius: "8px" }}
            >
              Select project
            </Link>
          </div>
...
//MAIN CONTAINER
const AdminprojectContainer = styled.div`
    margin: 6rem auto;
    padding: 3rem 14rem;
